...
const dpsCounters = [
  { hero: "Anran", image: "https://d15f34w2p8l1cc.cloudfront.net/overwatch/2cdf460c6080a031258e513713d1d635a8e68799cb5d7e27774be8963e95f6a3.png", counters: { tank: [{name: "Zarya", level: "hard"}, {name: "D.Va", level: "soft"}], dps: [{name: "Cassidy", level: "hard"}, {name: "Ashe", level: "soft"}], support: [{name: "Ana", level: "hard"}, {name: "Kiriko", level: "hard"}] }, logic: `Disruption & Hitscan: Anran wins when allowed to stay at a mid-range rhythm. Use Zarya to block her projectiles and Cassidy to "Hinder" her mobility, making her an easy target for follow-up.` },
  ...
  { hero: "Genji", image: "https://d15f34w2p8l1cc.cloudfront.net/overwatch/156b12c20b1aea872c1eeb5bb37a7de1047b2ab30ecefd0663a8925badde1ea8.png", counters: { tank: [{name: "Winston", level: "hard"}, {name: "Zarya", level: "hard"}], dps: [{name: "Mei", level: "hard"}, {name: "Symmetra", level: "hard"}], support: [{name: "Moira", level: "hard"}, {name: "Brigitte", level: "soft"}] }, synergies: ["Torbjörn", "Cassidy"] },
